...
// KITA KEMBALIKAN BANK SOAL KE SINI AGAR MUNCUL DI UI
const interviewQuestionBank = {
  'Adaptability': {
    operator: ["Kalau kamu tiba-tiba dipindah ke area produksi atau memegang mesin yang belum pernah kamu kerjakan sebelumnya, apa yang akan kamu lakukan pertama kali?", "Pernahkah kamu mendapat giliran shift malam padahal biasanya bekerja di shift pagi? Bagaimana caramu membiasakan kondisi badanmu?", "Kalau ada mandor atau kepala regu baru yang gaya kerjanya sangat berbeda dengan mandor lamamu, bagaimana caramu menyesuaikan diri dengan aturan barunya?"],
    admin: ["Kalau pabrik tiba-tiba mengganti program komputer atau format laporan Excel dengan yang baru, apa yang akan kamu lakukan supaya cepat paham?", "Biasanya kamu mendata barang keluar, tapi hari ini tiba-tiba diminta menggantikan teman yang sakit untuk mengecek barang masuk di gudang. Bagaimana tanggapanmu?", "Pernahkah kamu dipindah meja kerja atau digabung satu ruangan dengan tim dari divisi lain? Bagaimana caramu berbaur dan berkomunikasi dengan mereka?"]
  },
  'Creativity': {
    operator: ["Saat sedang mengejar target produksi, tiba-tiba bahan baku di mejamu habis dan petugas suplai sedang tidak ada. Apa akalmu supaya pekerjaanmu tidak berhenti lama?", "Pernahkah kamu menemukan cara atau posisimu sendiri supaya tugas menyortir/mengemas barang bisa selesai lebih cepat dari teman-temanmu tapi tetap rapi?"],
    admin: ["Kalau kamu harus merekap ratusan lembar bon kertas tapi waktunya sangat mepet, adakah cara atau urutan kerja yang kamu buat sendiri supaya lebih cepat selesai?", "Pernahkah kamu kesulitan mencari satu lembar dokumen penting di antara tumpukan kertas yang berantakan? Bagaimana caramu mencarinya dengan cepat?"]
  },
  'Curiosity': {
    operator: ["Kerja produksi menuntut kita hafal cara kerja banyak mesin dan alat. Waktu baru pertama kali diajari, bagian apa yang biasanya paling ingin kamu pelajari duluan?", "Kalau melihat teman kerjamu memakai alat bantu yang belum kamu tahu fungsinya, apakah kamu biasa bertanya atau membiarkannya saja? Kenapa?"],
    admin: ["Saat sedang membuat data di komputer, apakah kamu suka mencari tahu rumus atau tombol cepat (shortcut) baru supaya kerjamu lebih enak?", "Kalau ada istilah aneh atau singkatan di surat jalan yang belum kamu pahami, kepada siapa dan bagaimana caramu bertanyanya?"]
  },
  'Emotional Intelligence': {
    operator: ["Di area pabrik itu biasanya bising dan mandor kadang bicara dengan nada tinggi/berteriak karena pusing mengejar target. Bagaimana sikapmu saat ditegur dengan keras?", "Waktu badanmu sudah sangat capek, tiba-tiba teman regumu bekerja sangat lambat sehingga tugasmu ikut terhambat. Bagaimana caramu menegurnya tanpa bikin keributan?"],
    admin: ["Kalau ada sopir truk pengiriman atau orang lapangan yang marah-marah minta surat jalan cepat dicetak padahal kamu sedang merekap data lain, apa yang kamu lakukan?", "Pernahkah atasan menyuruhmu mengetik ulang laporan sampai tiga kali karena ada format yang salah terus? Bagaimana perasaanmu saat itu dan apa yang kamu lakukan?"]
  },
  'Initiative': {
    operator: ["Kalau target kuota kerjamu hari ini kebetulan sudah beres, tapi jam pulang pabrik masih setengah jam lagi, apa yang biasanya akan kamu kerjakan?", "Saat berjalan ke area istirahat, kamu melihat genangan oli atau air di lantai yang bisa bikin orang terpeleset. Padahal itu area kebersihan, apa yang kamu lakukan?"],
    admin: ["Kalau semua data hari ini sudah kamu masukkan ke sistem dan atasan belum memberi tugas baru, biasanya apa yang kamu lakukan di mejamu?", "Kamu melihat tumpukan map lama berdebu dan tidak beraturan di lemari kantor. Padahal merapikan lemari bukan tugas utamamu, apa yang akan kamu lakukan?"]
  },
  'Resilience': {
    operator: ["Kerja produksi mengharuskan kamu berdiri lama dan mengulang gerakan tangan yang sama ribuan kali dari pagi ke sore. Bagaimana caramu agar tidak gampang lelah atau bosan?", "Kalau target pabrik hari ini sangat tinggi dan mengharuskan kamu lembur mendadak padahal badan sudah lumayan pegal, bagaimana tanggapanmu?"],
    admin: ["Menjadi admin berarti harus betah menatap layar komputer dan memelototi angka-angka berjam-jam. Bagaimana caramu menjaga mata dan pikiran agar tidak mengantuk atau pusing?", "Saat akhir bulan (tutup buku), biasanya banyak tagihan yang harus dibereskan sampai harus lembur malam di kantor. Apakah kamu siap menghadapi rutinitas seperti ini?"]
  },
  'Integrity': {
    operator: ["Kalau kamu tidak sengaja menjatuhkan barang produksi sampai rusak, tapi kebetulan tidak ada pengawas yang melihat, apa yang akan kamu lakukan?", "Teman akrabmu mengajak mematikan sensor mesin atau melepas helm/masker pelindung supaya bisa bekerja lebih leluasa. Apa tindakanmu?"],
    admin: ["Kalau ternyata jumlah barang fisik di gudang dengan catatan di komputermu tidak sama (selisih), apakah kamu akan jujur melapor atau mengubah angka di komputer secara diam-diam agar cocok?", "Teman akrabmu datang telat dan mengirim pesan agar kamu memalsukan jam absensinya di buku depan. Apa balasan yang akan kamu berikan kepadanya?"]
  },
  'Motivation': {
    operator: ["Selain karena butuh penghasilan, adakah alasan lain mengapa kamu tertarik bekerja sebagai operator di pabrik kami dibanding bekerja di tempat lain?", "Pekerjaan lapangan ini sangat menguras keringat. Apa yang biasanya ada di pikiranmu supaya kamu tetap semangat berangkat dari rumah setiap hari?"],
    admin: ["Menurutmu, apa yang membuat pekerjaan administrasi itu menarik atau membuatmu betah, padahal kerjanya hanya duduk di depan komputer setiap hari?", "Pekerjaan admin itu kadang jarang terlihat hasilnya oleh orang lapangan, tapi datanya sangat penting. Apa yang membuatmu bangga bisa mengerjakan posisi ini?"]
  },
  'Resolution': {
    operator: ["Bel tanda pulang sudah berbunyi, tapi di sekeliling mesin kerjamu masih banyak sisa potongan bahan yang kotor. Apakah kamu akan menyapunya dulu atau langsung pulang?", "Waktu pergantian shift, teman penggantimu belum juga datang padahal mesinmu tidak boleh ditinggal mati. Apa yang akan kamu lakukan?"],
    admin: ["Sudah waktunya pulang kantor, tapi laporan pengeluaran harian yang kamu kerjakan ternyata angkanya belum seimbang (balance). Apa yang akan kamu putuskan?", "Meja kerjamu kebetulan masih penuh dengan tumpukan dokumen rahasia milik perusahaan padahal jam kantor sudah usai. Apa yang kamu lakukan sebelum meninggalkan meja?"]
  }
};

const initialCandidates = [
  { id: 1, name: 'Kartika Sari', email: 'kartika@example.com', phone: '0812-3456-7890', role: 'Admin Pabrik', date: '2026-05-24', status: 'DONE', score: 86, zoomLink: 'https://zoom.us/j/111222333', traits: { adaptability: 85, creativity: 70, curiosity: 80, eq: 85, initiative: 90, resilience: 80, integrity: 100, motivation: 85, resolution: 75 } },
  { id: 2, name: 'Damai Sejahtera', email: 'damai@example.com', phone: '0812-9876-5432', role: 'Pelaksana Operator', date: '2026-05-25', status: 'WAITING', score: null, zoomLink: 'https://zoom.us/j/444555666', traits: null },
  { id: 3, name: 'Budi Santoso', email: 'budi@example.com', phone: '0812-1111-2222', role: 'Pelaksana Operator', date: '2026-05-24', status: 'DONE', score: 65, zoomLink: 'https://zoom.us/j/777888999', traits: { adaptability: 65, creativity: 60, curiosity: 70, eq: 65, initiative: 60, resilience: 75, integrity: 80, motivation: 70, resolution: 65 } },
  { id: 4, name: 'Siti Aminah', email: 'siti@example.com', phone: '0812-3333-4444', role: 'Admin Pabrik', date: '2026-05-23', status: 'DONE', score: 45, zoomLink: 'https://zoom.us/j/123123123', traits: { adaptability: 45, creativity: 50, curiosity: 45, eq: 50, initiative: 40, resilience: 50, integrity: 60, motivation: 45, resolution: 40 } },
  { id: 5, name: 'Ahmad Faisal', email: 'ahmad@example.com', phone: '0812-5555-6666', role: 'Supervisor Produksi', date: '2026-05-24', status: 'DONE', score: 92, zoomLink: 'https://zoom.us/j/321321321', traits: { adaptability: 90, creativity: 85, curiosity: 90, eq: 95, initiative: 95, resilience: 90, integrity: 100, motivation: 95, resolution: 90 } }
];
...
export default function App() {
  ...
  useEffect(() => {
    if (pdfCandidate) {
      ...
      setTimeout(() => {
        ...
        if (element) {
          const opt = { 
            margin: 0, filename: `Laporan_IntegritAS_${pdfCandidate.name.replace(/\s+/g, '_')}.pdf`, image: { type: 'jpeg', quality: 1.0 }, 
            html2canvas: { scale: 2, useCORS: true, scrollY: 0, scrollX: 0 }, jsPDF: { unit: 'px', format: [794, 1123], orientation: 'portrait' } 
          };
  ...
  const RecruiterView = () => {
    ...
    const renderAnalysisReport = (candidateData, isPDF = false) => {
       ...
       const kesimpulanText = isRoleAdmin ? `"Kandidat teliti dan teratur. Profil psikologisnya cocok menangani data operasional atau pembukuan yang butuh akurasi."` : `"Kandidat disiplin dan patuh instruksi. Profilnya siap menghadapi ritme kerja lapangan dan shift pabrik yang dinamis."`;
         ...
         <div id={isPDF ? "hidden-pdf-content" : "pdf-content"} className={isPDF ? 'w-[794px] h-[1123px] bg-white p-8 font-sans box-border text-slate-800' : 'max-w-4xl mx-auto space-y-4 pb-10 bg-white p-4 sm:p-6 rounded-2xl shadow-sm border border-slate-100'}>
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-slate-50 border border-slate-200 rounded-xl p-3 gap-3">
              ...
              <div className="flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-end">
                  {candidateData.score >= 80 ? (<div className="bg-emerald-100 text-emerald-800 border border-emerald-200 rounded-lg px-3 py-1.5 flex items-center gap-1.5 shadow-sm"><Check size={12} strokeWidth={3}/> <span className="text-xs font-bold uppercase tracking-wide">Hire</span></div>) : candidateData.score >= 65 ? (<div className="bg-amber-100 text-amber-800 border border-amber-200 rounded-lg px-3 py-1.5 flex items-center gap-1.5 shadow-sm"><AlertTriangle size={12} strokeWidth={3}/> <span className="text-xs font-bold uppercase tracking-wide">Consider</span></div>) : (<div className="bg-red-100 text-red-800 border border-red-200 rounded-lg px-3 py-1.5 flex items-center gap-1.5 shadow-sm"><X size={12} strokeWidth={3}/> <span className="text-xs font-bold uppercase tracking-wide">Reject</span></div>)}
              ...
              <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 pb-20">
                ...
                <div className="flex-1 space-y-6">
                  ...
                  <div className="bg-white rounded-3xl border p-6">
                    ...
                    {/* KOTAK PERTANYAAN DASAR DIKEMBALIKAN KE SINI */}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-6 md:mb-8">
                      {aiQuestions[activeInterviewAspect] && (
                        <button onClick={() => setSelectedQuestions(prev => ({ ...prev, [activeInterviewAspect]: aiQuestions[activeInterviewAspect] }))} className={`text-left p-4 md:p-5 rounded-2xl text-xs md:text-sm font-medium leading-relaxed transition-all w-full ${ selectedQuestions[activeInterviewAspect] === aiQuestions[activeInterviewAspect] ? 'bg-purple-100 border-2 border-purple-500 text-purple-900 shadow-md ring-2 ring-purple-500/20' : 'bg-purple-50 border border-purple-200 text-purple-800 hover:bg-purple-100/80' }`}>
                          <div className="flex items-center gap-2 mb-2 text-purple-600 font-bold text-[10px] uppercase tracking-wider"><Sparkles size={12} /> AI GENERATED</div>
                          {aiQuestions[activeInterviewAspect]}
                        </button>
                      )}
                    ...
                    <textarea className="w-full p-6 bg-slate-50 border-2 border-transparent rounded-[32px] min-h-[220px] outline-none text-sm" placeholder={selectedQuestions[activeInterviewAspect] ? `Menjawab: "${selectedQuestions[activeInterviewAspect]}"\n\nMasukkan poin jawaban wawancara...` : "Masukkan poin jawaban wawancara..."} value={interviewAnswers[activeInterviewAspect] || ''} onChange={(e) => setInterviewAnswers({...interviewAnswers, [activeInterviewAspect]: e.target.value})} />
                  </div>
                </div>
              </div>
            )}
